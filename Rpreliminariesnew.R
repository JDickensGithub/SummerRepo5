...
# 4 Evaluate 6 times the difference between between the square
# of 5 and 3.
6*(5^2 - 3)
...
# 6a Evaluate ln(1000)    (Natural log,  base e)
log(1000)  

# Calculations for bases other than e or 10

# 6b Evaluate log343 base 7
log(343, base = 7)

# 6c Evaluate log 625 base 5
log(625, base = 5)

# Finding Quotients and Remainders

# 6d
# Use R coding to find the Quotient when 13 is divided by 4
# Use the operator %/%
13%/%4

# 6e
# Use R coding to find the Remainder when 13 is divided by 4
# Use the operator %%
...
# 16 Divide 1 by 7 and then round the answer to the nearest
# hundredth (use one line of code)

round((1/7),  digits = 2)

# 17a Find the numerical approximation for pi.   
# (We should get  3.141593)

pi

# 17b Use R code to find an approximation for e !!
# We should get approximately 2.7182818
...
# 20 Create a vector to find the 1st and third quartiles value
# of a set of numbers. Find the 1st and 3rd quartiles of the 
# numbers 17 , 6, 10, 12
...
# 21  Write a function  to find the area of a square.   
# ( A =  s^2)
...
# Find simple interest if $200 is invested at 5% for 2 years.
  ...
  # Copy, Paste, and Substitute for new calculations
  
  
  
#23  Use R code to write a function that calculates a weighted 
  #  average if chapter exams account for 40% of your grade,
  #  homework accounts for 30% of your grade,  classwork accounts
  #  for 10% of your grade, and the final exam
...
# Now find the weighted average if a student has a chapter exam 
# average of 80, a homework average of 84, a classwork
# average of 76, and a final exam score of 78.
WA(80,84,76,78)

# STAT 614 only
# Using R to find statistical summary values and to create graphs
# and plots
...
# Let's find important quantitative summaries for the
# data (y)

summary(y)

# Let's create a stem and leaf plot
